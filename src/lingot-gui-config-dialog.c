...
void lingot_gui_config_dialog_set_audio_device(GtkComboBoxEntry* combo,
...
void lingot_gui_config_dialog_set_audio_device(GtkComboBoxEntry* combo,
	...
	gtk_entry_set_text(GTK_ENTRY(GTK_BIN(combo)->child), filtered_name);
}
