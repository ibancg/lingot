...
pkgdatadir = $(datadir)/lingot
pkglibdir = $(libdir)/lingot
pkgincludedir = $(includedir)/lingot
top_builddir = .
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/lingot.desktop.in $(top_srcdir)/configure AUTHORS \
...
am__installdirs = "$(DESTDIR)$(gnomemenudir)" \
	"$(DESTDIR)$(lingotdocdir)"
gnomemenuDATA_INSTALL = $(INSTALL_DATA)
lingotdocDATA_INSTALL = $(INSTALL_DATA)
DATA = $(gnomemenu_DATA) $(lingotdoc_DATA)
ETAGS = etags
CTAGS = ctags
...
ACLOCAL = ${SHELL} /home/jairo/Projects/lingot/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/jairo/Projects/lingot/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/jairo/Projects/lingot/missing --run autoconf
AUTOHEADER = ${SHELL} /home/jairo/Projects/lingot/missing --run autoheader
AUTOMAKE = ${SHELL} /home/jairo/Projects/lingot/missing --run automake-1.9
AWK = gawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
MAKEINFO = ${SHELL} /home/jairo/Projects/lingot/missing --run makeinfo
MKINSTALLDIRS = ./mkinstalldirs
MSGFMT = /usr/bin/msgfmt
NO_PREFIX_PACKAGE_DATA_DIR = share
NO_PREFIX_PACKAGE_DOC_DIR = doc/lingot
NO_PREFIX_PACKAGE_HELP_DIR = share/gnome/help/lingot
NO_PREFIX_PACKAGE_MENU_DIR = share/gnome/apps
NO_PREFIX_PACKAGE_PIXMAPS_DIR = share/pixmaps/lingot
OBJEXT = o
PACKAGE = lingot
PACKAGE_BUGREPORT = 
...
infodir = ${prefix}/info
install_sh = /home/jairo/Projects/lingot/install-sh
...
lingotdocdir = ${prefix}/doc/lingot
lingotdoc_DATA = \
	README\
	COPYING\
	AUTHORS\
...
lingot.desktop: $(top_builddir)/config.status $(srcdir)/lingot.desktop.in
...
install-lingotdocDATA: $(lingotdoc_DATA)
	...
	@list='$(lingotdoc_DATA)'; for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  f=$(am__strip_dir) \
	  echo " $(lingotdocDATA_INSTALL) '$$d$$p' '$(DESTDIR)$(lingotdocdir)/$$f'"; \
	  $(lingotdocDATA_INSTALL) "$$d$$p" "$(DESTDIR)$(lingotdocdir)/$$f"; \
	done
...
uninstall-lingotdocDATA:
	...
	@list='$(lingotdoc_DATA)'; for p in $$list; do \
	  f=$(am__strip_dir) \
	  echo " rm -f '$(DESTDIR)$(lingotdocdir)/$$f'"; \
	  rm -f "$(DESTDIR)$(lingotdocdir)/$$f"; \
	done
...
installdirs-am:
	for dir in "$(DESTDIR)$(gnomemenudir)" "$(DESTDIR)$(lingotdocdir)"; do \
...
install-data-am: install-gnomemenuDATA install-lingotdocDATA
...
.PHONY: $(RECURSIVE_TARGETS) CTAGS GTAGS all all-am am--refresh check \
	...
	install-info-am install-lingotdocDATA install-man \
